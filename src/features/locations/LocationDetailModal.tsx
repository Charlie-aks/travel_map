...
export function LocationDetailModal() {
  ...
  return (
    <Sheet open={isDetailModalOpen} onOpenChange={setDetailModalOpen}>
      <SheetContent side="right" className="flex flex-col max-sm:w-[100vw]! max-sm:max-w-[100vw]! max-sm:h-dvh! max-sm:rounded-none w-[95vw] md:min-w-[70vw] lg:min-w-[60vw] max-w-[95vw] p-0 bg-[#f8fafc] dark:bg-slate-950 overflow-hidden border-0 rounded-l-xl shadow-2xl transition-colors" aria-describedby="dialog-description">
